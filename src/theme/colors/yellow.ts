...
export const yellow = defineSemanticTokens.colors({
    ...
    a1: { value: { _light: '#aaaa0006', _dark: '#d1510007' } },
    a2: { value: { _light: '#f4dd0016', _dark: '#f9b4000b' } },
    a3: { value: { _light: '#ffee0047', _dark: '#ffb70033' } },
    a4: { value: { _light: '#ffe3016b', _dark: '#ffb60047' } },
    a5: { value: { _light: '#ffd5008f', _dark: '#ffba0059' } },
    a6: { value: { _light: '#ebbc0097', _dark: '#f2a9006b' } },
    a7: { value: { _light: '#d2a10098', _dark: '#eab2008a' } },
    a8: { value: { _light: '#c99700c6', _dark: '#e9a600ab' } },
    a9: { value: { _light: '#ffe100d6', _dark: '#ffe629' } },
    a10: { value: { _light: '#ffdc00', _dark: '#ffff57' } },
    a11: { value: { _light: '#9e6c00', _dark: '#fee949' } },
    a12: { value: { _light: '#2e2000e0', _dark: '#f6eeb4' } },
    solid: {
        bg: {
            DEFAULT: { value: { _light: '{colors.yellow.9}', _dark: '{colors.yellow.9}' } },
            hover: { value: { _light: '{colors.yellow.10}', _dark: '{colors.yellow.10}' } },
        },
        fg: { DEFAULT: { value: { _light: '#21201c', _dark: '#21201c' } } },
    },
    subtle: {
        bg: {
